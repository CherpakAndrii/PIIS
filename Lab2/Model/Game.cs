...
public class Game
{
    ...
    public Game(FieldModel field, (short, short) start, (short, short) finish, AdjacencyType adjacency, Method method, byte enemyNumber = 1)
    {
        ...
        DecisionTree = method == Method.Minimax ?
            new MiniMaxAlgo(startPosition, enemies[0].Item1, enemies[0].Item2, 6, this) :
            new AlphaBetaAlgo(startPosition, enemies[0].Item1, enemies[0].Item2, 6, this);
    }
